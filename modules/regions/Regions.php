...
class Regions extends Module
{
    ...
    {
        $view = new View('regions/templates/Regions.view.php');
        $leftPanel = new View('admin/templates/LeftPanel.view.php');
        $row = new View('regions/templates/RegionRow.view.php');
        $table = new View('regions/templates/RegionsTable.view.php');
        
        $createRegion = '<div class="input-group">
